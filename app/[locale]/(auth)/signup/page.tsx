...
export default function SignUpPage() {
    ...
    const onSubmit = (data: FormValues) => {
        ...
        console.log("Sign up with:", {...data, userType});
            ...
            <div className="w-full max-w-md">
                ...
                <Link href="/" className="text-center block">
                    ...
                    <p className="text-muted-foreground">
                        {t("subtitle") || "Join as a job seeker or employer"}
                    </p>
                </Link>
                            ...
                            {t(`userType.${type}`) || (type === "applicant" ? "Job Seeker" : "Employer")}
                                ...
                                <div className="flex items-start space-x-3">
                                    <Checkbox
                                        ...
                                        required
                                    />
                                    <Label htmlFor="terms" className="ml-1 text-sm font-normal leading-tight cursor-pointer">
